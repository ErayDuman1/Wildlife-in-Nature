...
public class InsectsIdentificationActivity extends ImageHelperActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LocalModel localModel = new LocalModel.Builder().setAssetFilePath("insects_model.tflite").build();
