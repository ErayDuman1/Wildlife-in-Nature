...
public class PlantIdentificationActivity extends ImageHelperActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LocalModel localModel = new LocalModel.Builder().setAssetFilePath("classifier_plant.tflite").build();
