package com.example.win.audio;

import android.media.AudioRecord;
import android.util.Log;
import android.view.View;

import com.example.win.helpers.AudioHelperActivity;
...
public class BirdSoundDetectorActivity extends AudioHelperActivity {

    String modelPath = "bird_audio_metadata.tflite";
